    ...
    if(request.getParameter("outTradeNo")!=null){
       ...
       // AlipayTradePrecreateContentBuilder builder = new AlipayTradePrecreateContentBuilder()
        ...
        AlipayTradePrecreateRequestBuilder builder =new AlipayTradePrecreateRequestBuilder()
              ...
              .setNotifyUrl("http://172.18.48.119/CatShop/order/success.jsp")//支付宝服务器主动通知商户服务器里指定的页面http路径,根据需要设置
        ...
        switch (result.getTradeStatus()) {
            case SUCCESS:
                ...
                fileName = String.format("images%sqr-%s.png", File.separator, res.getOutTradeNo());
...
function zfb(){
	$.get('zfb.action',{outTradeNo:'<%=outTradeNo%>'},function(data){
		if(data==1){
			 window.location.href="order/success.jsp?outTradeNo=<%=outTradeNo%>";
		}
	});
